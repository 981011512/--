...
public class CfUserForm implements Serializable {
    ...
    public CfUserForm(String id, String userName, String password, String avatar, Byte type, String nickName, String trueName, Long birthday, Byte sex, String sign, Long createTime, String phone, String email) {
        this.id = id;
